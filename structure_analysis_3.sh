...
input_file=$input/Ash_farm_172_pacbio_contigs_unmasked_3_filtered_thinned_1000.recode.vcf
...
#Ash_farm_172_pacbio_contigs_unmasked_filtered_3_thinned.recode.struc in project file so had to copy to SNP_calling folder
cp Ash_farm_172_pacbio_contigs_unmasked_3_filtered_thinned_1000.recode.struc SNP_calling/Ash_farm_172_pacbio_contigs_unmasked_3_filtered_thinned_1000.recode.struc
